    ...
    <main className="bg-[#ded7c8] text-[#17130f]">
      ...
      <section className="relative flex min-h-[88svh] items-center overflow-hidden px-5 py-24 sm:px-8">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-14 md:grid-cols-[0.55fr_1fr] md:items-end">
          ...
          <div>
            <h1 className="font-serif text-[clamp(4.5rem,12vw,10rem)] font-light leading-[0.68] tracking-[-0.05em]">Wearable <span className="italic">Props</span></h1>
            <p className="mt-10 max-w-xl border-l border-[#8a5e35]/45 pl-6 text-[0.9rem] leading-8 text-black/48">The Wearable Props folder is currently empty. This page is prepared as a future archive for body-scaled objects, costume elements, masks, and painted wearable forms.</p>
